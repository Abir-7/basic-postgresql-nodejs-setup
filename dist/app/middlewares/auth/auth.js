...
var auth = function () {
    ...
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var tokenWithBearer, token, decodedData, userData;
        return __generator(this, function (_a) {
            tokenWithBearer = req.headers.authorization;
            if (!tokenWithBearer || !tokenWithBearer.startsWith("Bearer")) {
                return [2 /*return*/, next(new AppError_1.default(http_status_1.default.UNAUTHORIZED, "You are not authorized"))];
            }
            token = tokenWithBearer.split(" ")[1];
            if (token === "null") {
                return [2 /*return*/, next(new AppError_1.default(http_status_1.default.UNAUTHORIZED, "You are not authorized"))];
            }
            decodedData = jwt_1.jsonWebToken.verifyJwt(token, config_1.appConfig.jwt.jwt_access_secret);
            userData = { email: "sdsd", role: "ddd" };
            if (!userData) {
                return [2 /*return*/, next(new AppError_1.default(http_status_1.default.UNAUTHORIZED, "You are not authorized"))];
            }
